...
- Restored `X-KDE-Submenu` grouping in the Dolphin service menu (KIO regression fixed upstream)
...
[1.2.1]: https://github.com/shrippen/dolphin-davinci-audio-tools/releases/tag/v1.2.1
